...
class MyDB:
    ...
    def save_metadata(self, directory_name):
        ...
        # full_path = f"/Users/Aven/Desktop/myDB/Database/{directory_name}"
    ...
    def save_table(self, directory_name):  # anytime we modify a table
        ...
        # full_path = f"/Users/Aven/Desktop/myDB/Database/{directory_name}/tables/{table_name}"
        ...
        if count > 0:
            ...
            if table_size < 50:
                ...
                with open(path, 'w') as file:
                    file.write(data)
                return
        # if the last file in the table is over 50, create a new file and write the data on it
    ...
    def find_records(self, attributes, conditions, condition_type, table_name, directory_name, order_type, order_attribute):
        ...
        if not order_type:
            ...
            # path = f"/Users/Aven/Desktop/myDB/Database/{directory_name}/tables/{table_name}"
        else:
            # p = f"/Users/Aven/Desktop/myDB/Database/{directory_name}/tables/{table_name}/sorted_{table_name}"
            p = os.path.join(current_directory, "myDB", "Database", directory_name, "tables", table_name, f"sorted_{table_name}")
